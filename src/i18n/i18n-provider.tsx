...
const EN_TEXT: Record<string, string> = {
  ...
  "entry.heading": "Report what happened — without figuring out the form first.",
  "entry.support": "Speak in your language, upload screenshots, or type what happened. We’ll prepare the report and ask only for what’s missing.",
  "entry.demo": "Try demo case",
  "entry.live": "Try with test evidence",
  "entry.note": "Demo uses synthetic information only. No login, microphone or personal information is required.",
  "entry.urgent": "Money lost recently? Call 1930 now.",
  "entry.noLogin": "No login, microphone or personal information is required.",
  "entry.stepSpeak": "Speak naturally",
  "entry.stepEvidence": "Reuse your evidence",
  "entry.stepReview": "Review before submission",

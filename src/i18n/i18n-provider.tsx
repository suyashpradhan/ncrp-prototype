...
const EN_TEXT: Record<string, string> = {
  ...
  "workspace.coverage": "View NCRP field coverage",
  ...
  "workspace.declaration": "I have reviewed the information above and confirm that it is correct for this synthetic demo.",
  ...
  "complaint.response": "This prototype demonstrates a simpler way to prepare a structured financial cyber-fraud complaint using voice, evidence and only the missing information the citizen needs to supply.",

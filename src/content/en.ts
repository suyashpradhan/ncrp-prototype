...
export const UI_MESSAGES = {
  ...
  footer: {
    guardrail: message(
      "footer.guardrail",
      "This prototype explains synthetic state and does not determine legal entitlement.",
    ),
  ...
  about: {
    ...
    conciseIntro: message("about.conciseIntro", "This is an independent hackathon prototype."),
    noLiveSystem: message("about.noLiveSystem", "No live government system is connected."),
...
export const CITIZEN_MESSAGES = {
  ...
  detail: {
    ...
    compactNoAction: message("citizenDetail.compactNoAction", "Nothing required from you right now."),
  ...
  how: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: message(
          "how.step2.body",
          "Banks, police and other actors may be responsible for different portions.",
        ),
      },
      {
        ...
        body: message(
          "how.step3.body",
          "It tells the citizen what is happening, who needs to act and whether they need to do anything.",
        ),
      },
    ],
  },

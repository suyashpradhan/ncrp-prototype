...
export const CITIZEN_MESSAGES = {
  ...
  detail: {
    ...
    exitedMeaning: message(
      ...
      "No bank-restoration process is currently recorded for this amount in the synthetic case.",
    ),
    notHeldMeaning: message(
      "citizenDetail.notHeldMeaning",
      "There is no active restoration process or process window recorded for this amount in the synthetic case.",
    ),
